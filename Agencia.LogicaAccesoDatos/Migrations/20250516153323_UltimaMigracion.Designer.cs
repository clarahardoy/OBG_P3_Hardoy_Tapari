...
namespace Agencia.LogicaAccesoDatos.Migrations
{
    ...
    [Migration("20250516153323_UltimaMigracion")]
            ...
            modelBuilder.Entity("Agencia.LogicaNegocio.Entidades.EnvioUrgente", b =>
                {
                    ...
                    b.Property<bool?>("_entregaEficiente")
                        .HasColumnType("bit");

                    b.ComplexProperty<Dictionary<string, object>>("_direccionDestino", "Agencia.LogicaNegocio.Entidades.EnvioUrgente._direccionDestino#Direccion", b1 =>
                        {
                            b1.IsRequired();
                            ...
                            b1.Property<string>("_departamento")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");
                        });
